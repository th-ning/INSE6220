"""
This script calculates similarity matrices between different sets of classification results.
It compares the results from three different directories: data_dir1, data_dir2, and data_dir3.
The similarity is calculated using the cosine similarity measure between the cluster labels of each pair of files.

In this script we will load files from 3 dirs
...
data_dir1 = r'C:\Users\123456\Documents\PCA project\Classification(All_GFP)'
