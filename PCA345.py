...
target_eigenvalues_folder = "C:\\Users\\123456\\Documents\\PCA project\\ReduceDimensionValue(Peaks)"
target_eigenvectors_folder = "C:\\Users\\123456\\Documents\\PCA project\\VectorAfterReduce(Peaks)"
target_final_matrix_folder = "C:\\Users\\123456\\Documents\\PCA project\\FinalMatrix(Peaks)"'''

source_folder = "C:\\Users\\123456\\Documents\\PCA project\\MergedAll"
target_eigenvalues_folder = "C:\\Users\\123456\\Documents\\PCA project\\ReduceDimensionValue(All)"
target_eigenvectors_folder = "C:\\Users\\123456\\Documents\\PCA project\\VectorAfterReduce(All)"
target_final_matrix_folder = "C:\\Users\\123456\\Documents\\PCA project\\FinalMatrix(All)"
...
for folder in range(1, 25):
    ...
    for file in os.listdir(current_folder):
        if file.endswith(".csv"):
            ...
            reduced_eigenvalues_df.to_csv(reduced_eigenvalues_file_path, index=True)
            reduced_eigenvectors_df.to_csv(reduced_eigenvectors_file_path, index=True)

            # Compute the final matrix
            final_matrix = np.dot(df, reduced_eigenvectors.T)
