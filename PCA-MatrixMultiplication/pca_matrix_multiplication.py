"""
This script performs matrix multiplication between two CSV files and saves the result to a new CSV file.
It reads two CSV files containing matrices, performs matrix multiplication, and handles the dimensions and errors.
It serves for project task: Multiple Standard All matrix with PCA Vectors matrix (From Peak matrix(From Standard All))
