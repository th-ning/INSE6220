...
input_dir_original = r'C:\Users\123456\Documents\PCA project\StandardDataMatrix(PCA)(All)(new)'
input_dir_clustered = r'C:\Users\123456\Documents\PCA project\ClusterPeaks（GFPStandardAll)'
output_dir = r'C:\Users\123456\Documents\PCA project\Classification(StandardAll)'
...
for folder_name in os.listdir(input_dir_original):
    ...
    output_filename = f"{folder_name}_All_GFP_Classification.csv"
