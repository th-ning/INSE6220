...
input_dir_original = r'C:\Users\123456\Documents\PCA project\FinalStandardAllMulPeaksEigenvectors'
input_dir_clustered = r'C:\Users\123456\Documents\PCA project\ClusterPeaks（PCAGFPStandardAll)'
output_dir = r'C:\Users\123456\Documents\PCA project\Classification(All_GFP_PCA)'
...
for folder_name in os.listdir(input_dir_original):
    ...
    output_filename = f"{folder_name}_All_GFP_PCA_Classification.csv"
