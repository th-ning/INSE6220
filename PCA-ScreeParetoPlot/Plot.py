"""
This script reads a CSV file containing data and performs principal component analysis (PCA) to calculate the explained variance.
It then plots the explained variance and cumulative explained variance.
